Pod::Spec.new do |s|
  ...
  s.source                = { :git => "https://github.com/timRabbit/GJWNavigationDemo.git",:tag => s.version.to_s  }
  s.ios.deployment_target = "8.0"
  s.requires_arc          = true
  s.framework             = "CoreFoundation","Foundation","CoreGraphics","Security","UIKit"
  s.library		= "z.1.1.3","stdc++","sqlite3"
  s.source_files = 'NavigationDemo/NavigationAnimate'
