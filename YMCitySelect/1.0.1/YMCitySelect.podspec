Pod::Spec.new do |s|
  s.name                  = "YMCitySelect"
  s.version               = "1.0.1"
  s.summary               = "选择城市的 pod , 不支持横竖屏切换"
  s.homepage              = "http://https://github.com/timRabbit/YMCitySelect"
  s.social_media_url      = "http://https://github.com/timRabbit/YMCitySelect"
  s.platform     = :ios,'6.0'
  s.license               = { :type => "MIT", :file => "LICENSE" }
  s.author                = { " tim" => "491590253@qq.com" }
  s.source                = { :git => "https://github.com/timRabbit/YMCitySelect.git",:tag => "1.0.1" }
